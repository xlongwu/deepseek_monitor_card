...
pub struct DashboardSummary {
    ...
    pub today_estimated_cost_cny: String,
    pub today_estimated_cost_usd: String,
    pub last_hour_cost_cny: String,
    pub last_hour_cost_usd: String,
...
pub struct UsageStats {
    ...
    pub total_estimated_cost_cny: String,
    pub total_estimated_cost_usd: String,
